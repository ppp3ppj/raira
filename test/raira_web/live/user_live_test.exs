defmodule RairaWeb.UserLiveTest do
  use RairaWeb.ConnCase

  import Phoenix.LiveViewTest
  import Raira.AccountsFixtures

  @create_attrs %{first_name: "some first_name", last_name: "some last_name", username: "some username", email: "some email", confirmed_at: "2025-10-07T13:25:00Z"}
  @update_attrs %{first_name: "some updated first_name", last_name: "some updated last_name", username: "some updated username", email: "some updated email", confirmed_at: "2025-10-08T13:25:00Z"}
  @invalid_attrs %{first_name: nil, last_name: nil, username: nil, email: nil, confirmed_at: nil}
